...
public class AdminLogin extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		Admin admin =new Admin();
        	...
        	admin = service.adminLogin(email,pass);
            ...
            if(admin!=null) {
                pw.println("<h2 class='bg-primary text-light text-center'>login Successfully</h2>");
            }else {
                pw.println("<h2 class='bg-danger text-light text-center'> Not login</h2>");
            }
